...
def resnet_v1(inputs,
    ...
    Args:
      inputs: A tensor of size [batch, depth, height_in, width_in, channels].
    ...
    Returns:
      net: A rank-5 tensor of size [batch, depth, height_out, width_out, channels_out].
        ...
        with slim.arg_scope([slim.conv3d, bottleneck,
            ...
            with (slim.arg_scope([slim.batch_norm], is_training=is_training)
                ...
                if include_root_block:
                    ...
                    net = slim.conv3d(net, 64, [1, 7, 7], stride=[1, 2, 2], padding='SAME', scope='conv1')
                ...
                if num_classes:
                    net = slim.conv3d(net, num_classes, [1, 1, 1], activation_fn=None,
