...
python tensorflow_rename_variables.py --checkpoint_dir=path/to/dir --replace_from=scope1 --replace_to=scope1/model --add_prefix=abc/ --save_path=path/to/save/model
...
def rename(checkpoint_dir, replace_from, replace_to, add_prefix, dry_run, save_path):
...
def main(argv):
    ...
    rename(checkpoint_dir, replace_from, replace_to, add_prefix, dry_run, save_path)
