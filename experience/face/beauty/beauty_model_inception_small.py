...
input image size=139, minimum input size of inception v4
126 iter18799, av_rmse:38.6897, av_peason:0.8906
127 iter18899, av_rmse:38.5752, av_peason:0.8846
128 iter18999, av_rmse:39.7646, av_peason:0.8938
129 iter19000, av_rmse:38.7924, av_peason:0.8943
130 iter19099, av_rmse:39.3978, av_peason:0.8911
131 iter19199, av_rmse:37.6445, av_peason:0.9002
132 iter19299, av_rmse:39.5432, av_peason:0.8888
133 iter19399, av_rmse:38.0277, av_peason:0.8900
134 iter19499, av_rmse:39.5647, av_peason:0.8865
135 iter19500, av_rmse:39.4392, av_peason:0.8908
136 iter19599, av_rmse:38.3830, av_peason:0.8961
137 iter19699, av_rmse:38.2356, av_peason:0.8846
138 iter19799, av_rmse:40.2658, av_peason:0.8888
139 iter19899, av_rmse:39.7553, av_peason:0.8923
140 iter19999, av_rmse:38.9362, av_peason:0.8893
141 iter20000, av_rmse:36.2825, av_peason:0.8994
142 iter20099, av_rmse:40.1892, av_peason:0.8893
143 iter20199, av_rmse:39.6816, av_peason:0.8862
144 iter20299, av_rmse:37.7280, av_peason:0.8966
145 iter20399, av_rmse:39.5003, av_peason:0.8846
146 iter20499, av_rmse:39.4263, av_peason:0.8856
147 iter20500, av_rmse:38.6370, av_peason:0.8939
148 iter20599, av_rmse:40.3780, av_peason:0.8863
149 iter20699, av_rmse:37.9782, av_peason:0.8924
150 iter20799, av_rmse:38.3618, av_peason:0.8937
151 iter20899, av_rmse:40.6908, av_peason:0.8849
152 iter20999, av_rmse:38.8041, av_peason:0.8901
153 iter21000, av_rmse:38.7258, av_peason:0.8890
154 iter21099, av_rmse:39.0392, av_peason:0.8940
155 iter21199, av_rmse:40.5583, av_peason:0.8803
156 iter21299, av_rmse:37.3364, av_peason:0.9032
"""
...
def build_inception_model(x_input, y_input, reg_input, reuse, is_training, FLAGS):
    ...
    with tf.variable_scope('Beauty', 'BeautyV1', reuse=reuse) as scope:
        # 1 x 1 x 1536
        net = slim.dropout(end_points['global_pool'], dropout, scope='Dropout_1b')
...
def train_model(FLAGS):
    ...
    with tf.Session(config=config) as sess, open(log_path, 'w') as writer:
        ...
        for step in range(FLAGS.max_iter):
            ...
            if (step % 500 == 0) or (step >= 3000 and (step + 1) % FLAGS.valid_freq == 0):
